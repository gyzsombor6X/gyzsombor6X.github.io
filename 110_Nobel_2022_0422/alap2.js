    ...
    .then(y => 
        {
            ...
            for (elem of y.prizes)
            {
                ...
                {
                    sz+='<li>';
                    sz+='<button style="margin: 20px;" data-bs-toggle="collapse" data-bs-target="#demo'+elem.category+'" class="btn btn-danger">Részletek</button>';
                    sz+=elem.category;
